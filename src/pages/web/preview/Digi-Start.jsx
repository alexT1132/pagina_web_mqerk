...
const COURSE = {
  ...
  description:
    `Curso introductorio diseñado para que los estudiantes se familiaricen con el uso esencial de la computadora y las principales herramientas digitales. Se enfoca en la paquetería Office y aplicaciones prácticas que facilitan el aprendizaje, la productividad y el desarrollo de habilidades tecnológicas necesarias en la vida académica y laboral.
`,
  aprenderas: [
