...
import Logo from "../assets/mqerkacademy/MQerK_logo.png";
      ...
      <div className="hidden md:block">
        <div className="flex justify-between sep">
          ...
          <div className="flex space-x-4 justify-center items-center gap-6 mqerk-dis" style={{color: '#401454'}}>
              <Link onClick={() => inicioRef.current?.scrollIntoView({ behavior: 'smooth' })} to='/' className="text-lg text-white p-2 rounded-2xl ">Inicio</Link>
              <Link to='/acerca_de' className="text-lg text-white p-2 rounded-2xl ">Acerca de</Link>
              <Link to='/' onClick={scrollToCursos} state={{ ejecutarFuncion: true }} className="text-lg text-white gap-1 p-2 flex justify-center items-center rounded-2xl">
                Cursos
              </Link>
              ...
              <Link className='text-white flex justify-center items-center hover:bg-white hover:text-[#3c24ba] gap-2 py-6 font-bold w-40 h-10 border rounded-lg login'>
